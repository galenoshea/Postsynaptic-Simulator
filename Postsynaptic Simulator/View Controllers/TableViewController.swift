...
class TableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private let levels = [("Level 1", "Beginning"), ("Level 2", "Regenerative Action Potentials"), ("Level 3", "Spatial Summation"), ("Level 4", "Temporal Summation"), ("Level 5", "Coincidence Potentiation"), ("Level 6", "Inhibitory Transmitters"), ("Level 7", "Spatial Summation vs Decay"), ("Level 8", "Threshold & Action Potentials")]
